  ...
  <div class="info-container">
    <el-card class="box-card">
      ...
      <div class="search-box">
        <div class="search">
          <span>输入搜索：</span>
          <el-input style="width:200px" placeholder="快传账号" v-model="objSearch.q"></el-input>
        </div>
        <div class="search">
    ...
    <el-card class="box-card">
      <div class="table-list">
        ...
        <el-table :data="tableData" border @selection-change="handleSelectionChange" style="width: 100%">
          ...
          <el-table-column label="快传账号" prop="kuaichuan_account">
          </el-table-column>
...
const rules = {
  kuaichuan_account: [{ required: true, message: "请输入快传账号", trigger: "blur" }],
  kuaichuan_pwd: [{ required: true, message: "请输入快传密码", trigger: "blur" }],
