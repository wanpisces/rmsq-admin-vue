    ...
    <div>
      <el-card class="box-card">
        ...
        <div class="search-box">
          <div class="search">
            <span>输入搜索：</span>
            <el-input style="width:200px" v-model="search.q" placeholder="评选标题"></el-input>
          </div>
          <div class="search">
            <span>状态：</span>
        ...
        <div class="table-list">
          <div class="table-title">
            ...
            <div class="table-title-right">
              ...
              <choose-tab @handleAdd="handleAdd(1)" @TimeOn="timeOn" add-title="新建评选">
              </choose-tab>
            </div>
          </div>
          <el-table :data="tableData" border style="width: 100%" v-loading='loading' element-loading-text="拼命加载中...." element-loading-spinner="el-icon-loading" ref="table" @row-click="handleCurrentChange" @selection-change="selectionChange">
            ...
            <el-table-column label="评选标题" align="center">
            ...
            <el-table-column fixed="right" label="操作" width="150" align="center">
              <template slot-scope="scope">
                <!-- <span v-if="scope.row.status == 2">
                  <router-link :to="{path:'previewReputes'+urlLastId,query:{vote_id:scope.row.vote_id}}">
                    <el-button type="text" size="small"> 预览 </el-button>
                  </router-link>
                  <el-button @click="changeVoteStatus(scope.row.vote_id)" type="text" size="small"> 发布 </el-button>
                </span>
                <span v-else>
                  <router-link :to="{path:'viewReputes'+urlLastId,query:{vote_id:scope.row.vote_id}}">
...
export default {
  ...
  methods: {
    ...
    handleAdd(type, _vote_id) {
      if (type == 1) {
        this.$router.push({
          path: "addRepute" + this.urlLastId
        });
      } else {
        this.$router.push({
          path: "editRepute" + this.urlLastId,
