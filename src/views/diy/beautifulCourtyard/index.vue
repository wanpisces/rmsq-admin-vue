<template>
  <div class="info-container">
    <div v-if="!dialogVisible">
      <el-card class="box-card">
        ...
        <div class="search-box">
          <div class="search">
            <span>输入搜索：</span>
            <el-input style="width:200px" v-model="search.q" placeholder="院落编号、名称或录入人员姓名"></el-input>
          </div>
          <div class="search ">
      ...
      <el-card class="box-card">
        <div class="table-list">
          ...
          <el-table :data="tableData" border style="width: 100%" v-loading='loading' element-loading-text="拼命加载中...." element-loading-spinner="el-icon-loading" ref="table" @row-click="handleCurrentChange" @selection-change="selectionChange">
            ...
            <el-table-column prop="item_no" width="100" label="院落序号" align="center">
            </el-table-column>
            <el-table-column prop="item_title" label="院落名称" align="center">
            </el-table-column>
            <el-table-column prop="item_pic" width="220" label="院落首页展示图" align="center">
    ...
    <view-courtyard v-else @cancelPre="cancelPre" :itemId="detailItemId"></view-courtyard>
...
export default {
  components: { MoPaging, ChooseTab, viewCourtyard },
