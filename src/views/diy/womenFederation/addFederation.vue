    ...
    >
      ...
      >
        <el-form-item
          label="案例编号："
          prop="item_no"
          :rules="[{ required: true, message: '请填写案例编号' },{ validator: checkItemNo, trigger: 'blur' }]"
        >
        ...
        <el-form-item label="内容：">
          ...
          <Ueditor
            @changeCover="selectContent(0)"
            @changeContent="changeContent"
            :placeholderMsg="placeholderMsg"
            :dataObject="form.item_content"
            :config="config"
            :id="1+''"
            ref="ue"
          ></Ueditor>
...
export default {
  ...
  data() {
    return {
      ...
      form: {
        poll_id: "528683002784382976", // 投票ID
        item_no: "", // 投票项编号
        item_title: "", // 	投票项标题
        item_pic: "", // 投票项封面图
        // 投票项详情
  ...
  methods: {
    ...
    backToList() {
      const _url = !this.item_id ? "/addFederation" : "/editFederation";
      this.$router.push({
