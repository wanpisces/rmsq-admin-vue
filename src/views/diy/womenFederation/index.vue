            ...
            >
              <template slot-scope="scope">
                <div
                  ...
                  class="img-bg-box"
                  :style="{backgroundImage: 'url(' + scope.row.item_pic + ')'}"
                >
                </div>
                <span v-else>-</span>
              </template>
            ...
            >
              <template slot-scope="scope">
                <el-button
                  type="text"
                  size="small"
                  @click="showDetail(scope.row.item_id)"
                >查看</el-button>
                <el-button
                  type="text"
                  size="small"
                  @click="handleAdd(2,scope.row.item_id)"
                >编辑</el-button>
              </template>
            </el-table-column>
          </el-table>
  ...
  methods: {
    ...
    preview() {
      ...
      window.open(
        this.url,
        "_blank",
        "width=450,height=700,left=500,top=300",
        false
      );
    },
    // 获取列表数据
