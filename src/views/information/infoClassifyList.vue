          ...
          <el-table-column fixed="right" label="操作" width="100">
            <template slot-scope="scope">
              ...
              <!-- <div class="el-icon-wrapper">
                <i class="el-icon-edit" title="编辑" @click="handEditor(scope.row)"></i>
                <i class="el-icon-delete" title="删除" @click="deleteClassfiy(scope.row)"></i>
              </div> -->
            </template>
          </el-table-column>
        </el-table>
        ...
        if (valid) {
          ...
          if (this.oprateStatus == 1) {
            ...
            RequestClassfiyAdd(args).then(res => {
              oprateFn(res);
              if (res.code == 2000) this.objSearch.current_page = 1;
            });
          }
