  ...
  <div class="info-container">
    <el-card class="box-card">
      <el-form :model="fromData" ref="fromData" label-width="100px" class="demo-ruleForm">
        ...
        <el-form-item>
          <el-button type="primary" @click="submitForm('fromData')">发 布</el-button>
...
import { RequestGovAdd, RequestGovClassList } from "@/fetch/modules/service";
import { options2, options1 } from "@/fetch/tool";
export default {
  components: { Ueditor },
  data() {
    return {
