...
import { RequestActiveAttr, RequestActiveEditor, RequestActiveDetail, RequestActivieState } from "@/fetch/modules/service.js";
  ...
  methods: {
    ...
    editActive() {
      ...
      this.$store.dispatch("delVisitedViews", {
        path: "/active" + "/activeDetail" + this.lastUrlId
      });
    },
    // 发布活动
    submitForm() {
