<template>
  <div class="upload-container">
    <el-button icon='upload'  @click=" dialogVisible=true"  size="mini">视频上传
    </el-button>
    <el-dialog :visible.sync="dialogVisible" append-to-body>
      ...
      <div>
        ...
        <div style="line-height:40px">视频只支持mp4、avi，大小不超过30M</div>
      </div>
...
export default {
  ...
  methods: {
    ...
    vedioBeforeUpload(file) {
      ...
      if (isVedio == "video/mp4" || isVedio == "video/avi") {
